I attempted to connect to the cycle servers but it was simply not working, we spoke about this in class and I was not able to make it back to the lab in order to try using the cycle servers that way.
